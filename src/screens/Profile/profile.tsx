...
const Register = () => {
 ...
 const [data, setData] = useState({});
  ...
  const getUserData = async () =>{
   ...
   try{
        let result = await fetch('https://9b31-105-224-43-9.ngrok-free.app/Users/2b0ea48b-6fab-423f-b582-a2d9258906b2',{
...
const updateUserData = async () =>{
  ...
  try{
       let result = await fetch('https://9b31-105-224-43-9.ngrok-free.app/UserUpdate/2b0ea48b-6fab-423f-b582-a2d9258906b2',{
