...
const AppBarNav = () =>{
    ...
    return(
          <Drawer.Navigator  defaultStatus="closed"screenOptions={{ overlayColor: '#07137D',drawerActiveBackgroundColor:'#07137D',drawerActiveTintColor:'#FFB400'}}drawerContent={props => <DrawerContent{...props}/>}>
                    ...
                    <Drawer.Screen name='Requests' component={Requests} options={{headerTintColor:'#07137D', title: + count + ' Requests',drawerIcon: ({focused, size}) => ( <AntIcon name="mail" color={focused ? "#FFB400":"#07137D"} size={20} />),}}></Drawer.Screen>
